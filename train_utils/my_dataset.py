...
class CrackDataset(Dataset):
    def __init__(self, root: str, train: bool, transforms=None):
        ...
        data_root = r"D:\cracks\Semantic-Segmentation of pavement distress dataset\Combined"
        ...
        # data_root = root
        imgs_root = os.path.join(data_root, "DATASET_IMAGES")
        masks_root = os.path.join(data_root, "DATASET_MASKS")
