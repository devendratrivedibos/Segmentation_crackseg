...
def parse_args():
    ...
    parser.add_argument("--nr", default=1, type=int, help="Node rank (0 for master node)")
    parser.add_argument("--master-addr", default="192.168.1.16")
    parser.add_argument("--master-port", default="29500")

    # Training config
    parser.add_argument("--device", default="cuda")
    parser.add_argument("--data-path", default=r"V:\Devendra\ASPHALT\ASPHALT_ACCEPTED\COMBINED_SPLITTED")
