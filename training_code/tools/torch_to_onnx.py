...
if __name__ == "__main__":
    ...
    exporter_unet = ONNXExporter(
        model_type="unet",
        model_path= r"D:\Devendra_Files\segmentation_training\weights\2june_asp__best.pth",
        onnx_path=r"D:\Devendra_Files\segmentation_training\weights\2june_asp__best.onnx",
        input_size=(1024, 419),
