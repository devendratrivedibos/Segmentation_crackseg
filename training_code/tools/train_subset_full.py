...
def main(args):
    ...
    val_dataset = CrackDataset(args.data_path,
                               train=False,
                                 transforms=get_transform(train=False,img_size_h=img_size_h, img_size_w=img_size_w, mean=mean, std=std))
    ...
    for epoch in range(start_epoch, args.epochs):
        if args.use_subset:
            ...
            val_loader = get_subset_loader(val_dataset, args.batch_size, args.subset_size//10, num_workers=num_workers)
