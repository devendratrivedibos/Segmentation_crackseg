...
import random
# Input folders
images_folder = r"D:\cracks\Semantic-Segmentation of pavement distress dataset\Combined\DATA_TRAIN\DATASET_IMAGES_COPY"
masks_folder = r"D:\cracks\Semantic-Segmentation of pavement distress dataset\Combined\DATA_TRAIN\DATASET_MASKS_COPY"

# Output folders (must be different from input to avoid overwrite)
aug_images_folder = r"D:\cracks\Semantic-Segmentation of pavement distress dataset\Combined\DATA_TRAIN\DATASET_IMAGES_COPY"
aug_masks_folder = r"D:\cracks\Semantic-Segmentation of pavement distress dataset\Combined\DATA_TRAIN\DATASET_MASKS_COPY"
