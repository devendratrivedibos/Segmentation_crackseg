...
# --- Paths ---
BASE_DIR = r"Z:\Devendra\ASPHALT\ASPHALT_ACCEPTED\COMBINED_SPLITTED\TRAIN"
img_dir = os.path.join(BASE_DIR, "IMAGES")
mask_dir = os.path.join(BASE_DIR, "MASKS_TRAIL")
delete_mask_dir = os.path.join(BASE_DIR, "potpatch_mask")
delete_image_dir = os.path.join(BASE_DIR, "potpatch_image")
...
def process_mask(mask_name: str):
    ...
    if unique_ids in DELETE_SETS:
        try:
            ...
            shutil.copy(mask_path, os.path.join(delete_mask_dir, mask_name))
            ...
            if img_path:
                ...
                shutil.copy(img_path, os.path.join(delete_image_dir, os.path.basename(img_path)))
